...
#import "SpruceViewController.h"

@interface SpruceViewController ()
@property (weak, nonatomic) IBOutlet UIWebView *webView;

@end

@implementation SpruceViewController
@synthesize webView;
...
- (void)viewDidLoad
{
    ...
    NSURL *url = [NSURL URLWithString:@"http://spruceapp.herokuapp.com"];
