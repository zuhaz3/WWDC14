...
#import "YTFindViewController.h"

@interface YTFindViewController ()
@property (weak, nonatomic) IBOutlet UIWebView *webView;
@end

@implementation YTFindViewController
@synthesize webView;
...
- (void)viewDidLoad
{
    ...
    NSURL *url = [NSURL URLWithString:@"http://ytfind.com"];
